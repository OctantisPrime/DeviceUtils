...
public class StorageQueryUtil {
    ...
    public static StorageData queryWithStorageManager(StorageData storageData) {
        //5.0 查外置存储
        StorageManager storageManager = (StorageManager) DeviceMain.getApp().getSystemService(Context.STORAGE_SERVICE);
...
//        }
    ...
    public static long getTotalSize(String fsUuid) {
        try {
            ...
            StorageStatsManager stats = DeviceMain.getApp().getSystemService(StorageStatsManager.class);
    ...
    public static long getPhoneSize() {
        ActivityManager actManager = (ActivityManager) DeviceMain.getApp().getSystemService(Context.ACTIVITY_SERVICE);
