package com.octantis.prime.android.deviceutils.receiver;
...
import static com.octantis.prime.android.deviceutils.utils.OtherUtils.getBrightness;
...
//            batteryStatusData.device_id = getDeviceid();
            DeviceMain.batteryStatusData = batteryStatusData;
            if (DeviceMain.onlyBat) {
                DeviceMain.removeBoadcast();
            }
        }
    }
}
